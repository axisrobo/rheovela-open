...
**rheovela-open** 是 RHEOVELA 的**对外发布层**（Apache-2.0，当前 `v1.0.0-rc.1`）：版本化 contracts、5 语言 Worker SDK、HTTP Worker API、OpenAPI 与示例流程。完整功能见 [docs/FEATURES.md](docs/FEATURES.md)。
